...
import gov.va.os.reference.security.TokenResource;
import gov.va.os.reference.security.handler.JwtAuthenticationEntryPoint;
import gov.va.os.reference.security.handler.JwtAuthenticationSuccessHandler;
import gov.va.os.reference.security.jwt.JwtAuthenticationFilter;
import gov.va.os.reference.security.jwt.JwtAuthenticationProperties;
import gov.va.os.reference.security.jwt.JwtAuthenticationProvider;
import gov.va.os.reference.security.jwt.JwtParser;
import gov.va.os.reference.security.jwt.JwtTokenService;
...
public class ReferenceSecurityAutoConfiguration {
	 ...
	 */
	@Configuration
	@ConditionalOnProperty(prefix = "reference.security.jwt", name = "enabled", matchIfMissing = true)
	 ...
	 */
	@Configuration
	@ConditionalOnProperty(prefix = "reference.security.jwt", name = "enabled", havingValue = "false")
	@Order(JwtAuthenticationProperties.AUTH_ORDER)
	...
	@Bean
	@ConditionalOnMissingBean
	@ConditionalOnExpression("${reference.security.jwt.enabled:true} && ${reference.security.jwt.generate.enabled:true}")
