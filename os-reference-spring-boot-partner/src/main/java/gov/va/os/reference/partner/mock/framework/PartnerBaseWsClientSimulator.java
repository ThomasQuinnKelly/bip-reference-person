...
public class PartnerBaseWsClientSimulator {
	 ...
	 * probably better to use a private or a protected constructor in order to prevent instantiation than make the class
	 * misleadingly abstract.
	 */
	protected PartnerBaseWsClientSimulator() {
	}
	...
	protected final String getSimulatorResponseByFileName(final String fileName) throws IOException {
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	protected final String getSimulatorResponseByFileName(final String fileName1, final String fileName2)
			throws IOException {
