package gov.va.os.reference.security.util;

import static gov.va.os.reference.security.jwt.JwtAuthenticationProvider.isPersonTraitsValid;
...
import gov.va.os.reference.security.jwt.JwtAuthenticationException;
