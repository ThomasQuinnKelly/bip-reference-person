...
import gov.va.ocp.vetservices.claims.config.VetservicesClaimsFeignConfig;
...
fallbackFactory = FeignClaimsClientFallbackFactory.class,
configuration = VetservicesClaimsFeignConfig.class)
public interface FeignClaimsClient { // NOSONAR not a functional interface
