package gov.va.ocp.vetservices.claims.rest.client;
 ...
 */
@Component
public class FeignClaimsClientFallbackFactory implements FallbackFactory<FeignClaimsClient> {

	private static final OcpLogger LOGGER = OcpLoggerFactory.getLogger(FeignClaimsClientFallbackFactory.class);

	@Override
	public FeignClaimsClient create(Throwable cause) {
