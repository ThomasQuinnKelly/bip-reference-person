...
import gov.va.os.reference.partner.person.ws.client.remote.PersonRemoteServiceCallImpl;
...
public class PersonWsClientImpl extends BaseWsClientImpl implements PersonWsClient {
	 ...
	 * (non-Javadoc)
	 *
	 * @see gov.va.os.reference.partner.person.ws.client.PersonWsClient#getPersonInfoByPtcpntId(gov.va.os.reference.partner.person.ws.
