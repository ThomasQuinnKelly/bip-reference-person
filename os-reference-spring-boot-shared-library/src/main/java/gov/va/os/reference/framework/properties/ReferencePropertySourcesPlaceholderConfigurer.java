 ...
 * 
 */
public class ReferencePropertySourcesPlaceholderConfigurer extends PropertySourcesPlaceholderConfigurer {

	/** The configurable environment. */
	private ConfigurableEnvironment configurableEnvironment;

	/** The property source resolver wss. */
	private final ReferencePropertySourcesPropertyResolver propertySourceResolverWss = new ReferencePropertySourcesPropertyResolver();
	 ...
	 */
	public final ReferencePropertySourcesPropertyResolver getPropertySourceResolverWss() {
