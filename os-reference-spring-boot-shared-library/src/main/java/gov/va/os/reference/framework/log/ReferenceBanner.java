 ...
 * @author aburkholder
 */
public class ReferenceBanner {

	/** WARNING - DO NOT USE BANNER LOGGING FROM WITHIN THIS CLASS */
	private static final ReferenceLogger LOGGER = ReferenceLoggerFactory.getLogger(ReferenceBanner.class);
	 ...
	 */
	public ReferenceBanner(String bannerText, Level level) {
