...
public class BaseRestProviderAspect {
	 ...
	 * (3) the method returns org.springframework.http.ResponseEntity<gov.va.os.reference.framework.service.ServiceResponse+>
	 *
	 * Ensure you follow that pattern to make use of this standard pointcut.
	 */
	@Pointcut("execution(public org.springframework.http.ResponseEntity<gov.va.os.reference.framework.service.ServiceResponse+> *(..)) || execution(public gov.va.os.reference.framework.service.ServiceResponse+ *(..))")
	 ...
	 *
	 * (1) are annotated with gov.va.os.reference.framework.audit.Auditable
	 *
	 * Ensure you follow that pattern to make use of this standard pointcut.
	 */
	@Pointcut("@annotation(gov.va.os.reference.framework.audit.Auditable)")
	 ...
	 * This aspect defines the pointcut of methods that...
	 *
	 * (1) are annotated with gov.va.os.reference.framework.audit.Auditable (2) the
