...
import gov.va.os.reference.framework.exception.ExceptionHandlingUtils;
...
public class ExceptionHandlingUtilsTest {
	...
	public void testLoggingUtils() throws Exception {
		...
		Assert.assertTrue(loggingEvents.get(0).toString().startsWith(
				"[WARN] Catcher caught exception, handling it as configured.  Here are details [java.lang.Throwable thrown by gov.va.os.reference.framework.exception.ExceptionHandlingUtilsTest.testLoggingUtils] args [[Arg One, 42]]."));
	...
	public void testLoggingWarnOff() throws Exception {
		...
		Assert.assertEquals(
				"[ERROR] Catcher caught exception, handling it as configured.  Here are details [java.lang.Throwable thrown by gov.va.os.reference.framework.exception.ExceptionHandlingUtilsTest.someMethod] args [null].",
