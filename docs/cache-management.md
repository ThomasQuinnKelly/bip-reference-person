...
- The class gov.va.bip.framework.cache.BipCacheUtil in [bip-framework-libraries](https://github.ec.va.gov/EPMO/bip-ocp-framework/tree/master/bip-framework-libraries) project has functions to generate keys and conditionals for @CachePuts operation using Spring Expression Language (SpEL). Add more such methods as required and use them accordingly.
