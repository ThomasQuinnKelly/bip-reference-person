 ...
 * @author aburkholder
 */
public class OcpLogger extends OcpBaseLogger {
	 ...
	 */
	private OcpLogger(org.slf4j.Logger logger) {
		super(logger);
	}
	 ...
	 * @return OcpLogger
	 */
	public static final OcpLogger getLogger(org.slf4j.Logger logger) {
		return new OcpLogger(logger);
	}
	 ...
	 * @since 1.4
	 */
	public void debug(OcpBanner banner, String msg) {
	 ...
	 */
	public void debug(OcpBanner banner, String format, Object arg) {
		super.sendlog(Level.DEBUG,
				null,
	 ...
	 */
	public void debug(OcpBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.DEBUG,
				null,
	 ...
	 */
	public void debug(OcpBanner banner, String msg, Throwable t) {
		super.sendlog(Level.DEBUG,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void info(OcpBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void info(OcpBanner banner, String format, Object arg) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void info(OcpBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void info(OcpBanner banner, String msg, Throwable t) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void warn(OcpBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void warn(OcpBanner banner, String format, Object arg) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void warn(OcpBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void warn(OcpBanner banner, String msg, Throwable t) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void error(OcpBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void error(OcpBanner banner, String format, Object arg) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void error(OcpBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void error(OcpBanner banner, String msg, Throwable t) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
