 ...
 */
public enum HttpStatusForMessage {
	 ...
	 * {@code 103 Checkpoint}.
	 * 
	 * @see <a href="http://code.google.com/p/gears/wiki/ResumableHttpRequestsProposal">A proposal for supporting resumable POST/PUT
	 *      HTTP requests in HTTP/1.0</a>
	 */
	 ...
	 * 
	 * @see <a href="https://tools.ietf.org/html/draft-ietf-httpbis-legally-restricted-status-04"> An HTTP Status Code to Report Legal
	 *      Obstacles</a>
	 * @since 4.3
	 */
	...
	HttpStatusForMessage(final int value, final String reasonPhrase) {
	...
	/**
	 * Whether this status code is in the HTTP series {@link org.springframework.http.HttpStatus.Series#INFORMATIONAL}. This is a
	...
	/**
	 * Whether this status code is in the HTTP series {@link org.springframework.http.HttpStatus.Series#SUCCESSFUL}. This is a shortcut
	...
	/**
	 * Whether this status code is in the HTTP series {@link org.springframework.http.HttpStatus.Series#REDIRECTION}. This is a
	 * shortcut for checking the value of {@link #series()}.
	 *
	...
	/**
	 * Whether this status code is in the HTTP series {@link org.springframework.http.HttpStatus.Series#CLIENT_ERROR}. This is a
	 * shortcut for checking the value of {@link #series()}.
	 *
	...
	/**
	 * Whether this status code is in the HTTP series {@link org.springframework.http.HttpStatus.Series#SERVER_ERROR}. This is a
	 * shortcut for checking the value of {@link #series()}.
	 *
	...
	public String toString() {
		return Integer.toString(this.statusCodeValue);
	}
	...
	public enum Series {
		...
		public static Series valueOf(final int status) {
			...
			for (Series series : values()) {
				if (series.statusCodeValue == seriesCode) {
					return series;
				}
			}
		...
		public static Series valueOf(final HttpStatusForMessage status) {
			return valueOf(status.statusCodeValue);
		}
	}
