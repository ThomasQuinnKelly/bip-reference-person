...
public class BaseRestProviderAspect {
	 ...
	 *
	 * (1) are annotated with gov.va.ocp.reference.framework.audit.Auditable
	 *
	 * Ensure you follow that pattern to make use of this standard pointcut.
	 */
	@Pointcut("@annotation(gov.va.ocp.reference.framework.audit.Auditable)")
	 ...
	 * This aspect defines the pointcut of methods that...
	 *
	 * (1) are annotated with gov.va.ocp.reference.framework.audit.Auditable (2) the
