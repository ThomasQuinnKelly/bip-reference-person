 ...
 * @author aburkholder
 */
public class ReferenceLogger extends ReferenceBaseLogger {
	 ...
	 */
	private ReferenceLogger(org.slf4j.Logger logger) {
		super(logger);
	}

	/**
	 * Get an ReferenceLogger.
	 *
	 * @param logger an org.slf4j.Logger.Logger
	 * @return ReferenceLogger
	 */
	public static final ReferenceLogger getLogger(org.slf4j.Logger logger) {
		return new ReferenceLogger(logger);
	}
	 ...
	 * @since 1.4
	 */
	public void debug(ReferenceBanner banner, String msg) {
	 ...
	 */
	public void debug(ReferenceBanner banner, String format, Object arg) {
		super.sendlog(Level.DEBUG,
				null,
	 ...
	 */
	public void debug(ReferenceBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.DEBUG,
				null,
	 ...
	 */
	public void debug(ReferenceBanner banner, String format, Object... args) {
		super.sendlog(Level.DEBUG,
				null,
	 ...
	 */
	public void debug(ReferenceBanner banner, String msg, Throwable t) {
		super.sendlog(Level.DEBUG,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void info(ReferenceBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void info(ReferenceBanner banner, String format, Object arg) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void info(ReferenceBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param arguments a list of 3 or more arguments
	 */
	public void info(ReferenceBanner banner, String format, Object... args) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.arrayFormat(format, args).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void info(ReferenceBanner banner, String msg, Throwable t) {
		super.sendlog(Level.INFO,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void warn(ReferenceBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void warn(ReferenceBanner banner, String format, Object arg) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arguments a list of 3 or more arguments
	 */
	public void warn(ReferenceBanner banner, String format, Object... args) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.arrayFormat(format, args).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void warn(ReferenceBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void warn(ReferenceBanner banner, String msg, Throwable t) {
		super.sendlog(Level.WARN,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
	 ...
	 * @param msg the message string to be logged
	 */
	public void error(ReferenceBanner banner, String msg) {
	 ...
	 * @param arg the argument
	 */
	public void error(ReferenceBanner banner, String format, Object arg) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg).getMessage(),
				null);
	 ...
	 * @param arg2 the second argument
	 */
	public void error(ReferenceBanner banner, String format, Object arg1, Object arg2) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.format(format, arg1, arg2).getMessage(),
				null);
	 ...
	 * @param arguments a list of 3 or more arguments
	 */
	public void error(ReferenceBanner banner, String format, Object... args) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + MessageFormatter.arrayFormat(format, args).getMessage(),
				null);
	 ...
	 * @param t the exception (throwable) to log
	 */
	public void error(ReferenceBanner banner, String msg, Throwable t) {
		super.sendlog(Level.ERROR,
				null,
				banner.getBanner() + NEWLINE + msg,
				t);
