 ...
 */
package gov.va.os.reference.framework.properties;
...
import gov.va.os.reference.framework.config.BasePropertiesConfig.BasePropertiesEnvironment;
...
public class ReferencePropertySourcesPropertyResolverTest {
	...
	ReferencePropertySourcesPropertyResolver instance;

	public ReferencePropertySourcesPropertyResolverTest() {
	}

	@Before
	public void setUp() {
		instance = new ReferencePropertySourcesPropertyResolver();
	...
	/**
	 * Test of containsProperty method, of class ReferencePropertySourcesPropertyResolver.
	 * 
	 * @throws IOException
	 */
	@Test
	public void testContainsProperty() throws IOException {
		String key = "os-reference-partner.ws.client.endpoint";
	...
	public void testContainsProperty_null() throws IOException {
		String key = "os-reference-partner.ws.client.endpoints";
	...
	/**
	 * Test of getFromFileProperty method, of class ReferencePropertySourcesPropertyResolver.
	 * 
	 * @throws IOException
	 */
	@Test
	...
	/**
	 * Test of getProperty method, of class ReferencePropertySourcesPropertyResolver.
	 */
	@Test
	...
	public void testGetProperty_String_Null() {
		String key = "os-reference-partner.ws.client.endpointa:test";
	...
	/**
	 * Test of getPropertyFileHolders method, of class ReferencePropertySourcesPropertyResolver.
	 */
	@Test
	...
	/**
	 * Test of setPropertySources method, of class ReferencePropertySourcesPropertyResolver.
	 */
	@Test
	...
	/**
	 * Test of setPropertySourcesPropertyResolver method, of class ReferencePropertySourcesPropertyResolver.
	 */
	@Test
	public void testSetPropertySourcesPropertyResolver() {
		PropertyResolver propertySourcesPropertyResolver = null;
		ReferencePropertySourcesPropertyResolver instance = new ReferencePropertySourcesPropertyResolver();
		instance.setPropertySourcesPropertyResolver(propertySourcesPropertyResolver);
	}

	/**
	 * Test of setValueSeparator method, of class ReferencePropertySourcesPropertyResolver.
	 */
	@Test
