package gov.va.os.reference.security;
...
import gov.va.os.reference.security.model.Person;
import gov.va.os.reference.security.util.GenerateToken;
...
public class TokenResource implements SwaggerResponseMessages {
	...
	@Value("${reference.security.jwt.validation.required-parameters:}")
