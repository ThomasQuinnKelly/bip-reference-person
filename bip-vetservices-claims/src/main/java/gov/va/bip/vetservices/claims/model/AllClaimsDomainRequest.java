...
@NotNull(message = "{bip.vetservices.claims.request.NotNull}")
public class AllClaimsDomainRequest implements ProviderTransferObjectMarker {
	...
	@ApiModelProperty(value = "The Participant ID of the person for whom to retrieve data", required = true,
			example = "6666345")
	@NotNull(message = "{bip.vetservices.claims.request.pid.NotNull}")
	@Min(value = 1, message = "{bip.vetservices.claims.request.pid.Min}")
	private String pid;
